...
/// here, since nothing will be read from it, but the status is what the log line about moving on
/// needs — and "never answered" has to be distinguishable from any status a model could send.
/// </remarks>
internal readonly record struct ModelAttempt(HttpResponseMessage? Response, int Status, bool InCooldown = false);
